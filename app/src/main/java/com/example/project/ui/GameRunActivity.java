...
//        if (extras != null) {
//            String value = (String) extras.get("type");
//            if (value.equals("loadGame")) {
//                try {
...
//        String textOne = tamagotchi.getName() + " is wearing a " + tamagotchi.getHat().getName();
//        String textTwo = "Happy Meter: " + tamagotchi.getHappyMeter();
//        String textThree = "Today's weather is " + tamagotchi.getColour();
//        Toast myToast = Toast.makeText(this, "textOne\n textTwo\n textThree",
//                Toast.LENGTH_SHORT);
//        myToast.show();
//    }
//
